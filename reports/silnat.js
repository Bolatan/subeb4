...
document.addEventListener('DOMContentLoaded', function() {
    ...
    .then(surveys => {
        ...
        if (surveys.length === 0) {
            tableBody.innerHTML = '<tr><td colspan="4" style="text-align:center; padding: 20px;">No SILNAT reports found.</td></tr>';
            return;
        }
    ...
    .catch(error => {
        ...
        console.error('Error fetching SILNAT reports:', error);
    });
});
...
function exportToPDF() {
    ...
    doc.text("SILNAT Survey Reports", 14, 16);
    ...
    doc.save('silnat-survey-reports.pdf');
}
...
function exportToExcel() {
    ...
    XLSX.writeFile(workbook, "silnat-survey-reports.xlsx");
}
